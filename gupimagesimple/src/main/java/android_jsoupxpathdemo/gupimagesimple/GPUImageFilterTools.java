...
package android_jsoupxpathdemo.gupimagesimple;
...
import gpuimage.GPUImage3x3ConvolutionFilter;
...
import gpuimage.GPUImageFalseColorFilter;
import gpuimage.GPUImageFilter;
import gpuimage.GPUImageFilterGroup;
import gpuimage.GPUImageGammaFilter;
import gpuimage.GPUImageGaussianBlurFilter;
import gpuimage.GPUImageGlassSphereFilter;
import gpuimage.GPUImageGrayscaleFilter;
import gpuimage.GPUImageHalftoneFilter;
import gpuimage.GPUImageHardLightBlendFilter;
import gpuimage.GPUImageHazeFilter;
...
import gpuimage.GPUImageLaplacianFilter;
import gpuimage.GPUImageLevelsFilter;
...
import gpuimage.GPUImageNonMaximumSuppressionFilter;
import gpuimage.GPUImageNormalBlendFilter;
import gpuimage.GPUImageOpacityFilter;
...
import gpuimage.GPUImageRGBDilationFilter;
import gpuimage.GPUImageRGBFilter;
...
import gpuimage.GPUImageSmoothToonFilter;
import gpuimage.GPUImageSobelEdgeDetection;
import gpuimage.GPUImageSoftLightBlendFilter;
import gpuimage.GPUImageSourceOverBlendFilter;
import gpuimage.GPUImageSphereRefractionFilter;
import gpuimage.GPUImageSubtractBlendFilter;
import gpuimage.GPUImageSwirlFilter;
import gpuimage.GPUImageToneCurveFilter;
import gpuimage.GPUImageToonFilter;
import gpuimage.GPUImageTransformFilter;
import gpuimage.GPUImageTwoInputFilter;
import gpuimage.GPUImageVignetteFilter;
import gpuimage.GPUImageWeakPixelInclusionFilter;
import gpuimage.GPUImageWhiteBalanceFilter;
